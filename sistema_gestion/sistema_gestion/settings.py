...
SECRET_KEY = 'django-insecure-ivyi_pz+mrw@k8p9zz6x*hphru45hx&&bh918%vtr+0s-in!)b'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # Corregido: 'DIRS' debe estar fuera de 'context_processors'
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
